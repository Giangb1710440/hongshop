                    ...
                    <form action="{{ route('searchProduct') }}" method="get">
                        ...
                        <div class="advanced-search">
                            <div class="input-group">
                                <input type="text" placeholder="Bạn cần gì?" name="keyWord" style="color: black">
                    ...
                    <li><a href="#">Sản phẩm <i class="fa fa-caret-down" aria-hidden="true"></i></a>
                        <ul class="dropdown" style="width: 204px">
                            <li><a href="{{route('viewCate_product',2)}}">Giày Nam</a></li>
                                @foreach($nam as $nam)
                                    <li class="active">
                                        <a style="padding-left: 10px;font-size: 16px; font-family: 'Times New Roman';font-weight: normal" href="{{ route('viewCategory', $nam->id) }}">{{ $nam->name }}</a>
                                    </li>
                                @endforeach

                            <li><a href="{{route('viewCate_product',1)}}">Giày Nữ</a></li>
                                @foreach($nu as $nu)
                                    <li class="active">
                                        <a style="padding-left: 10px;font-size: 16px; font-family: 'Times New Roman';font-weight: normal" href="{{ route('viewCategory', $nu->id) }}">{{ $nu->name }}</a></li>
                                @endforeach
                        </ul>
                    </li>
